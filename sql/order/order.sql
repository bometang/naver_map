...
VALUES (ORDERS_SEQ.NEXTVAL, 'MOSI-20250818-001', 6, 55000);

INSERT INTO ORDERS (ORDER_ID, ORDER_CODE, BUYER_ID, TOTAL_PRICE)
VALUES (ORDERS_SEQ.NEXTVAL, 'MOSI-20250818-002', 6, 120000);

INSERT INTO ORDERS (ORDER_ID, ORDER_CODE, BUYER_ID, TOTAL_PRICE)
VALUES (ORDERS_SEQ.NEXTVAL, 'MOSI-20250818-003', 6, 89000);
